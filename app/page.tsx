  ...
  return (
    <main style={{ maxWidth: 920, margin: "2rem auto", padding: "0 1rem" }}>
      <h1 style={{ fontSize: "1.6rem", marginBottom: "0.75rem" }}>
        Aurora Vercel Proxy (Edge)
      </h1>
      <p style={{ marginTop: 0 }}>
        Paste an HLS <code>.m3u8</code> URL and optional Referer. Click Preview.
      </p>
      ...
      <div style={{ display: "grid", gap: "0.75rem", gridTemplateColumns: "1fr", marginTop: "1rem" }}>
        ...
        <label>
          ...
          <input
            ...
            placeholder="https://your-referer.example"
            style={{ width: "100%", padding: "0.6rem" }}
          />
        </label>
        <div style={{ display: "flex", gap: "0.5rem" }}>
          <button
            onClick={onPreview}
            style={{ padding: "0.6rem 1rem", border: "1px solid #ddd", borderRadius: 8, cursor: "pointer" }}
          >
            Preview
          </button>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            style={{ padding: "0.6rem 1rem", border: "1px solid #ddd", borderRadius: 8, textDecoration: "none" }}
          >
            Open raw playlist
          </a>
        </div>
      ...
      <p style={{ fontSize: 12, color: "#666", marginTop: "1rem" }}>
        Use only with content you have rights to access. Some origins block Vercel egress; the API returns 403 in those cases.
      </p>
    </main>
  );
}
